...
<table width="21%" class="table table-stripped">
	...
	$str="SELECT * FROM `view_order_details` where md5(kot) ='".$_GET['uid']."'";
	...
	<tr>
     ...
     <tr>
     	<td colspan="4">
        	<table width="100%">
            	<tr>
            	  <td  style="background:#999;color:#FFF">Table No.</td>
            	  <td  style="background:#999;color:#FFF"><strong>:</strong></td>
            	  <td  style="background:#999;color:#FFF"><?php $str2="SELECT * FROM `view_table_order` where id='".$r['order_mastid']."'"; 
																						$query2=mysql_query($str2);
																						$row2=mysql_fetch_array($query2); echo $row2['table_no'];?></td>
            	  <td  style="background:#999;color:#FFF">&nbsp;</td>
            	  <td  style="background:#999;color:#FFF">&nbsp;</td>
            	  <td  style="background:#999;color:#FFF">&nbsp;</td>
            	  <td  style="background:#999;color:#FFF">&nbsp;</td>
          	  </tr>
            	<tr>
                	<td width="22%"  style="background:#999;color:#FFF"><strong>Client No.</strong></td>
                    <td width="4%"  style="background:#999;color:#FFF"><strong>:</strong></td>
                    <td width="14%"  style="background:#999;color:#FFF"><strong><?php echo $row2['client_no'];  ?></strong></td>
                    <td width="11%"  style="background:#999;color:#FFF"><strong>&nbsp;</strong></td>
                    ...
                    <td width="21%"  style="background:#999;color:#FFF"><strong><?php $s2="SELECT * FROM `tbl_employee_master` where id='".$r['emp_id']."'";
					$q2=mysql_query($s2);
...
<p align="center" id="Pi"><input type="button" name="Save" value="Print" id="P" class="btn btn-danger"/> &nbsp;&nbsp;<a href="tableorder_dashboard.php" class="btn btn-danger">Home</a> </p>
