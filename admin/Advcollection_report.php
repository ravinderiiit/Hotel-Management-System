...
<div class="content">
	...
	<div class="content-container">
		<div class="entry-head"><h4><strong>Advance Collection Report </strong></h4></div>
			...
			$sql="select * from tbl_adv_account where confrm_stat=0 and trans_date between '$frmDt' and '$toDt'";
			$res=mysql_query($sql);
			?>
				<!------Query Result---------->
					...
					<div class="entry-content">	
						<table width="100%" class="table table-bordered">
							...
							<tr>
                                ...
                                <td align="center" style="color:#FFFFFF;background-color:#000000" width="15%"><strong>Cashier</strong></td>
							...
							<tr>
                              ...
                              <td align="center"><?=$emp["emp_name"]?></td>
