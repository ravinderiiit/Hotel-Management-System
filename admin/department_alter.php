...
<h4><strong>Add employee </strong>
  <div style="color:#FFFFFF; float:right"><a href="department_list.php"><img src="<?php echo IMAGE_PATH?>back.png" title="Go Back"   /></a></div> </h4>
...
<table width="100%" class="table table-striped">
	<tr>
	  <td width="17%" height="39">Department</td>
	  <td width="2%"><strong>:</strong></td>
	  <td><input type="text" required name="department" id="department" value="<?php echo $objCoreAdmin->department;?>"<?php echo $objCoreAdmin->disbableit;?> /> </td>
    </tr>
	<tr>
