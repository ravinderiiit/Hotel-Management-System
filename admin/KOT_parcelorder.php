	...
	<tr>
     ...
     <tr>
     	<td colspan="4">
        	<table width="100%">
            	<tr>
                	<td width="22%"  style="background:#999;color:#FFF"><strong>Name</strong></td>
                    <td width="4%"  style="background:#999;color:#FFF"><strong>:</strong></td>
                    <td width="10%"  style="background:#999;color:#FFF"><strong><?php $str2="SELECT * FROM `tbl_order_master` where id='".$r['order_mastid']."'"; 
																						$query2=mysql_query($str2);
																						$row2=mysql_fetch_array($query2); echo $row2['cust_no_name'];?></strong></td>
                    <td width="15%"  style="background:#999;color:#FFF"><strong>&nbsp;</strong></td>
...
<p align="center" id="Pi"><input type="button" name="Save" value="Print" id="P" class="btn btn-danger"/> &nbsp;&nbsp;<a href="parcelorder_list.php" class="btn btn-danger">Home</a> </p>
