...
<div class="content">
	...
	<div class="content-container">
		<div class="entry-head"><h4><strong>Booking Status Report</strong></h4></div>
			...
			$sql="select tbl_adv_booking_mstr.id
					,tbl_adv_booking_mstr.name
					,tbl_adv_booking_mstr.mobile
					,tbl_adv_booking_dtls.room_dtl_id
					,view_room_type_floor_dtl_wise.room_type
					,view_room_type_floor_dtl_wise.room_no
					,tbl_adv_booking_mstr.stampdate
					from tbl_adv_booking_mstr
					left join tbl_adv_booking_dtls on tbl_adv_booking_dtls.adv_booking_id=tbl_adv_booking_mstr.id
					left join view_room_type_floor_dtl_wise on view_room_type_floor_dtl_wise.id=tbl_adv_booking_dtls.room_dtl_id
					where tbl_adv_booking_mstr.suspended_status=0";
			$res=mysql_query($sql);
			?>
				<!------Query Result---------->
...
<td width="20%" align="center" style="color:#FFFFFF;background-color:#000000"><div align="center"><strong>Contact No.</strong> </div></td>							
</tr>
