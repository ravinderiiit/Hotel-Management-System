...
$(document).ready(function() {                
	...
	$("#cust_name,#contact_no").keyup(function(){
		$("#guest_name").val($("#cust_name").val());
		$("#guest_Contact_no").val($("#contact_no").val());
	});	  
...
<div class="entry-content">
		...
		<p></p>
			...
			?>
                ...
                <?php $taxcount++;}?>
				  ...
				  <tr>
					<td colspan="13" align="right"><input type="button" name="calculate" id="calculate" value="Calculate" class="btn"  onclick="cal()"/>
				    <input type="submit" name="Save" id="Save" value="Delete" class="btn btn-danger" onclick="return confirm('Are you sure to delete?')"/></td>
				  </tr>
				  </table>
				</div>
				<?php }
	...
	<p></p>
		<div class="innerBody">
			<table width="100%" class="table">
				<tr>
					...
					<td width="1%"><strong>:</strong></td>
				  <td>
				  <input required type="text" name="cust_name" id="cust_name"  value="<?=@$_POST["cust_name"]?>" placeholder="John\Marry etc..."/>	  </td>
				  <td>&nbsp;</td>
				  <td align="right">Age</td>
				  <td><strong>:</strong></td>
				  <td><input required type="text" name="cust_age" id="cust_age" value="<?=@$_POST["cust_age"]?>"/></td>
				  <td>&nbsp;</td>
				  <td>Father Name</td>
				  <td><strong>:</strong></td>
				  <td><input required type="text" name="father_name" id="father_name" value="<?=@$_POST["father_name"]?>" placeholder="John\Marry etc..."/></td>
				  </tr>
				<tr>
				  <td>Gender</td>
				  <td><strong>:</strong></td>
				  ...
				  <td width="1%"><strong>:</strong></td>
				  <td>
				  <select name="nation" id="nationality" required>
					  <option value="">--Select Country--</option>
					  <option value="Afghanistan" <?php if($_POST["nation"]=="Afghanistan"){ ?> selected="selected"<?php }?>>Afghanistan</option>
					  <option value="Australia"<?php if($_POST["nation"]=="Australia"){ ?> selected="selected"<?php }?>>Australia</option>
					  <option value="Bangladesh"<?php if($_POST["nation"]=="Bangladesh"){ ?> selected="selected"<?php }?>>Bangladesh</option>
					  <option value="Bhutan"<?php if($_POST["nation"]=="Bhutan"){ ?> selected="selected"<?php }?>>Bhutan</option>
					  <option value="Brazil"<?php if($_POST["nation"]=="Brazil"){ ?> selected="selected"<?php }?>>Brazil</option>
					  <option value="Canada"<?php if($_POST["nation"]=="Canada"){ ?> selected="selected"<?php }?>>Canada</option>
					  <option value="China"<?php if($_POST["nation"]=="China"){ ?> selected="selected"<?php }?>>China</option>
					  <option value="Colombia"<?php if($_POST["nation"]=="Colombia"){ ?> selected="selected"<?php }?>>Colombia</option>
					  <option value="Egypt"<?php if($_POST["nation"]=="Egypt"){ ?> selected="selected"<?php }?>>Egypt</option>
					  <option value="France"<?php if($_POST["nation"]=="France"){ ?> selected="selected"<?php }?>>France</option>
					  <option value="Germany"<?php if($_POST["nation"]=="Germany"){ ?> selected="selected"<?php }?>>Germany</option>
					  <option value="Ghana"<?php if($_POST["nation"]=="Ghana"){ ?> selected="selected"<?php }?>>Ghana</option>
					  <option value="Greenland"<?php if($_POST["nation"]=="Greenland"){ ?> selected="selected"<?php }?>>Greenland</option>
					  <option value="Hong Kong"<?php if($_POST["nation"]=="Hong Kong"){ ?> selected="selected"<?php }?>>Hong Kong</option>
					  <option value="India"<?php if($_POST["nation"]=="India"){ ?> selected="selected"<?php }?>>India</option>
					  <option value="Indonesia"<?php if($_POST["nation"]=="Indonesia"){ ?> selected="selected"<?php }?>>Indonesia</option>
					  <option value="iraq="iraq""<?php if($_POST["nation"]=="iraq"){ ?> selected="selected"<?php }?>>Iraq</option>
					  <option value="Ireland"<?php if($_POST["nation"]=="Ireland"){ ?> selected="selected"<?php }?>>Ireland</option>
					  <option value="Japan"<?php if($_POST["nation"]=="Japan"){ ?> selected="selected"<?php }?>>Japan</option>
					  <option value="Kenya"<?php if($_POST["nation"]=="Kenya"){ ?> selected="selected"<?php }?>>Kenya</option>
					  <option value="Kuwait"<?php if($_POST["nation"]=="Kuwait"){ ?> selected="selected"<?php }?>>Kuwait</option>
					  <option value="Mexico"<?php if($_POST["nation"]=="Mexico"){ ?> selected="selected"<?php }?>>Mexico</option>
					  <option value="Nepal"<?php if($_POST["nation"]=="Nepal"){ ?> selected="selected"<?php }?>>Nepal</option>
					  <option value="New Zealand"<?php if($_POST["nation"]=="New Zealand"){ ?> selected="selected"<?php }?>>New Zealand</option>
					  <option value="Pakistan"<?php if($_POST["nation"]=="Pakistan"){ ?> selected="selected"<?php }?>>Pakistan</option>
					  <option value="Philippines"<?php if($_POST["nation"]=="Philippines"){ ?> selected="selected"<?php }?>>Philippines</option>
					  <option value="Russian Federation"<?php if($_POST["nation"]=="Russian Federation"){ ?> selected="selected"<?php }?>>Russian Federation</option>
					  <option value="Saudi Arabia"<?php if($_POST["nation"]=="Saudi Arabia"){ ?> selected="selected"<?php }?>>Saudi Arabia</option>
					  <option value="Singapore"<?php if($_POST["nation"]=="Singapore"){ ?> selected="selected"<?php }?>>Singapore</option>
					  <option value="South Africa"<?php if($_POST["nation"]=="South Africa"){ ?> selected="selected"<?php }?>>South Africa</option>
					  <option value="Sri Lanka"<?php if($_POST["nation"]=="Sri Lanka"){ ?> selected="selected"<?php }?>>Sri Lanka</option>
					  <option value="United Kingdom"<?php if($_POST["nation"]=="United Kingdom"){ ?> selected="selected"<?php }?>>United Kingdom</option>
					  <option value="United States"<?php if($_POST["nation"]=="United States"){ ?> selected="selected"<?php }?>>United States</option>
					  <option value="Zambia"<?php if($_POST["nation"]=="Zambia"){ ?> selected="selected"<?php }?>>Zambia</option>
					  <option value="Zimbabwe"<?php if($_POST["nation"]=="Zimbabwe"){ ?> selected="selected"<?php }?>>Zimbabwe</option>
					</select>
				  </td>
				  </tr>
				<tr>
		...
		<textarea required name="address" id="address"  style="width:99%;height:40px;resize:none" placeholder="Please enter complete address such as Street\Ho.No\Landmark etc.."><?php echo $_POST["address"];?></textarea>		  
				  </td>
				  </tr>
				...
				<tr>
				  <td>Pin Code</td>
				  <td><strong>:</strong></td>
				  <td width="17%"><input required type="text" name="pincode" id="pincode" class="required digits" value="<?=@$_POST["pincode"]?>" placeholder="Enter Digits only"/></td>
				  <td width="2%">&nbsp;</td>
				  <td width="14%">Comming From</td>
				  <td width="1%"><strong>:</strong></td>
				  <td width="12%"><input required type="text" name="comming_from" id="comming_from" value="<?=@$_POST["comming_from"]?>"/></td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				...
				<tr>
				  <td>Male</td>
				  <td><strong>:</strong></td>
				  <td><input required type="text" name="male_no" id="male_no" placeholder="No. of male"  value="<?=@$_POST["male_no"]?>"/></td>
				  <td>&nbsp;</td>
				  <td>Female</td>
				  <td><strong>:</strong></td>
